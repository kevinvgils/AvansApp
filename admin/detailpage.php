...
<head>
    ...
    <link rel="stylesheet" href="../style/mapDetailpage.css">
        ...
        <div class="wrap row detailWrap">
            ...
            foreach (getAllQuestionsForRoute($_GET['id']) as $question) { ?>
                <div class="fullwidth questionDetail">
                    <div class="row">
                        <div class="col-9">
                            <h5 class="font-weight-bold">Vraag <?php echo $i . ": " . $question->question;
                                                                $i++; ?></h5>
                                ...
                                <div class="row">
                                    <div class="col-6 border-right mb-3">
                                        ...
                                        <div class="custom-control custom-checkbox mb-2">
                                            <input type="checkbox" class="custom-control-input" id="latLong" <?php if (checkCoords()) {
                                                                                                                    echo "checked";
                                                                                                                } ?> onchange="latLongChecked()">
                                            <label class="custom-control-label" for="latLong">Vraag met locatie?</label>
                                        </div>


                                        <div id="latLongDiv" class="row mb-2" <?php if (checkCoords()) {
                                        ...
                                        <select class="mb-2 custom-select" onchange="showSelected(this)">
                                            ...
                                            <option <?php if ($toSelect == 0) {
                                                        echo "selected";
                                                    } ?> value="none">---</option>
                                            <option <?php if ($toSelect == 1) {
                                                        echo "selected";
                                                    } ?> value="image">Afbeelding</option>
                                            <option <?php if ($toSelect == 2) {
                                                        echo "selected";
                                                    } ?> value="videoUrl">Youtube video</option>
                                        </select>

                                        <div id="videoUrlcontainer" <?php if ($toSelect == 2) {
                                        ...
                                        <label class="image" for="image" <?php if ($toSelect == 1) {
                                                                                echo "style='display: block;'";
                                                                            } ?>>Afbeelding</label>
                                    ...
                                    <div class="col-6 mb-3">
                                        ...
                                        <select id="selectQuestionType" class="mb-2 custom-select" name="type" onchange="showMultipleChoiceFields(this)">
                                            ...
                                            <option <?php if ($type == 0) {
                                                        echo "selected";
                                                    } ?> value="0">Meerkeuzevraag</option>
                                            <option <?php if ($type == 1) {
                                                        echo "selected";
                                                    } ?> value="1">Openvraag</option>
                                            <option <?php if ($type == 2) {
                                                        echo "selected";
                                                    } ?> value="2">Afbeeldingsvraag</option>
                                        </select>
                                        <div id="multipleChoice" <?php if (getValueWhenEdit("questionType") != 0 && isEditing()) {
                                            ...
                                            <select id="awnserCount" class="mb-2 custom-select" onchange="showAnswerFields(this)">
                                                ...
                                                <option <?php if ($count == 2) {
                                                            echo "selected";
                                                        } ?> value="2">2</option>
                                                <option <?php if ($count == 3) {
                                                            echo "selected";
                                                        } ?> value="3">3</option>
                                                <option <?php if ($count == 4) {
                                                            echo "selected";
                                                        } ?> value="4">4</option>
                                            </select>
                                            <?php
                                            ...
                                            <div class="input-group mb-2">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">
                                                        <input type="checkbox" name="answer1CK" value="1" <?php if (isEditing() && isset($questions[0]) && $questions[0]->isCorrect == 1) {
                                                                                                                echo "checked";
                                                                                                            } ?> id="answer1CK" aria-label="Checkbox for following answer to check if correct" onclick="selectOnlyThis(this.id)">
                                                    </div>
                                                </div>
                                                <input type="text" id="answer1Txt" name="answer1" class="form-control" value="
                                                <?php if (isEditing() && $count >= 1) {
                                                    echo $questions[0]->answer;
                                            ...
                                            <div class="input-group mb-2">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">
                                                        <input type="checkbox" name="answer2CK" value="1" <?php if (isEditing() && isset($questions[1]) && $questions[1]->isCorrect == 1) {
                                                                                                                echo "checked";
                                                                                                            } ?> id="answer2CK" aria-label="Checkbox for following answer to check if correct" onclick="selectOnlyThis(this.id)">
                                                    </div>
                                                </div>
                                                <input type="text" id="answer2Txt" name="answer2" class="form-control" value="
                                                <?php if (isEditing() && $count >= 2) {
                                                    echo $questions[1]->answer;
                                                } ?>" aria-label="Text input with checkbox" required>
                                            </div>
                                            <div id="answer3Div" <?php if (isEditing() && $count >= 3) {
                                                                        echo "style='display: block;'";
                                                                    } ?>>
                                                ...
                                                <div class="input-group mb-2">
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text">
                                                            <input type="checkbox" name="answer3CK" value="1" <?php if (isEditing() && isset($questions[2]) && $questions[2]->isCorrect == 1) {
                                                                                                                    echo "checked";
                                                                                                                } ?> id="answer3CK" aria-label="Checkbox for following answer to check if correct" onclick="selectOnlyThis(this.id)">
                                                        </div>
                                                    </div>
                                                    <input type="text" id="answer3Txt" name="answer3" class="form-control" value="
                                                    <?php if (isEditing() && $count >= 3) {
                                                        echo $questions[2]->answer;
                                                    } ?>" aria-label="Text input with checkbox">
                                                </div>
                                            </div>
                                            <div id="answer4Div" <?php if (isEditing() && $count >= 4) {
                                                                        echo "style='display: block;'";
                                                                    } ?>>
                                                ...
                                                <div class="input-group mb-2">
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text">
                                                            <input type="checkbox" name="answer4CK" value="1" <?php if (isEditing() && isset($questions[3]) && $questions[3]->isCorrect == 1) {
                                                                                                                    echo "checked";
                                                                                                                } ?> id="answer4CK" aria-label="Checkbox for following answer to check if correct" onclick="selectOnlyThis(this.id)">
                                                        </div>
                                                    </div>
                                                    <input type="text" id="answer4Txt" name="answer4" class="form-control" value="
                                                    <?php if (isEditing() && $count >= 4) {
                                                        echo $questions[3]->answer;
                                                    } ?>" aria-label="Text input with checkbox">
                                                </div>
                                            </div>
                                        </div>
