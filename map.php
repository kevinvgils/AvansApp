...
var avansIcon = L.icon({
  ...
  var avansPin = L.icon({
    ...
    var markerAvans = L.marker([coordAvansB, coordAvansL], { icon: avansIcon })
    .addTo(map)
    ...
    var markerChasse = L.marker([<?php echo $questionMarker->longitude ?>, <?php echo $questionMarker->latitude ?>], { icon: avansPin })
    .addTo(map)
    ...
    function getPosition(position){
        ...
        pointer = L.marker([lat, long], { icon: avansPin })
